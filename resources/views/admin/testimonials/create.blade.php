<x-app-layout>
    <x-slot name="header">New Endorsement</x-slot>
    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-[#161923] rounded-3xl border border-white/5 p-8 shadow-xl">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h4 class="text-white font-bold">Add Testimonial</h4>
                    <p class="text-xs text-gray-500">Capture positive feedback from a Proud Tech client.</p>
                </div>
            </div>
