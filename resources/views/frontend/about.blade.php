    ...
    <section class="py-24 md:py-48 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-10 text-center relative z-10">
            ...
            <p class="text-xl md:text-2xl text-slate-400 max-w-3xl mx-auto font-medium leading-relaxed">
                Membangun ekosistem digital presisi tinggi untuk bisnis yang menuntut keunggulan kompetitif di setiap
                piksel.
            </p>
        </div>
    </section>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-24">
                ...
                <div class="lg:w-1/2 space-y-12">
                    <h2 class="text-4xl md:text-6xl font-black text-white tracking-tighter uppercase leading-[0.9]">
                        Digerakkan oleh <span class="text-blue-500">Logika.</span> <br>
                        Dipandu oleh <span class="italic font-serif normal-case text-slate-500">Seni.</span>
                    </h2>
                    <p class="text-gray-400 text-lg md:text-xl font-medium leading-relaxed">
                        Didirikan atas prinsip bahwa pengalaman digital haruslah semulus keindahannya. Kami
                        beroperasi di persimpangan rekayasa performa tinggi dan estetika brand elit.
                    </p>
    ...
    <section class="py-20 md:py-40 relative">
        <div class="max-w-7xl mx-auto px-6 lg:px-10">
            <div class="text-center mb-24">
                <h2 class="text-blue-500 font-black uppercase tracking-[0.4em] text-xs mb-6">Protokol Kami</h2>
                <h3 class="text-3xl md:text-6xl font-black text-white tracking-tighter uppercase leading-none">Standar
                    <span class="text-gradient">Inti Kami.</span>
                </h3>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                @foreach ([['icon' => 'fas fa-microchip', 'color' => 'blue', 'title' => 'Kemurnian Teknis', 'desc' => 'Kami merancang untuk skalabilitas. Tanpa utang teknis, hanya repositori kode bersih berperforma tinggi.'], ['icon' => 'fas fa-swatchbook', 'color' => 'indigo', 'title' => 'Niat Estetis', 'desc' => 'Setiap piksel diperhitungkan. Kami memadukan fungsionalitas dengan prinsip desain digital kelas atas.'], ['icon' => 'fas fa-chart-line', 'color' => 'purple', 'title' => 'Dominasi Pertumbuhan', 'desc' => 'Rekayasa berorientasi hasil yang fokus pada kecepatan konversi, metrik performa, dan dominasi SEO.']] as $standard)
                    <div
